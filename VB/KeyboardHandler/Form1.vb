...
#Region "#substservice"
        ...
        Private Sub SubstituteKeyboardService()
            Dim service As IKeyboardHandlerService =
                richEditControl1.GetService(Of IKeyboardHandlerService)()
...
#Region "#myservice"
    Public Class MyKeyboardHandlerServiceWrapper
        ...
        Public Overrides Sub OnKeyDown(ByVal e As PortableKeyEventArgs)
            If ((e.KeyCode = PortableKeys.C) OrElse (e.KeyCode = PortableKeys.X) OrElse
                (e.KeyCode = PortableKeys.Insert)) AndAlso e.Control Then
                Return
            End If
            MyBase.OnKeyDown(e)
        End Sub
